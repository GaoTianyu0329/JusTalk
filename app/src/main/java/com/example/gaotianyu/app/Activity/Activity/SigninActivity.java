...
public class SigninActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_handin = (Button) findViewById(R.id.sign_hangin);
        button_handin.setOnClickListener(this);
                ...
                if (result == SMSSDK.RESULT_COMPLETE){
                    ...
                    if (event == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(SigninActivity.this,"验证成功",Toast.LENGTH_SHORT).show();
                                yanzheng = true;
                            }
                        });
                ...
                if (user.equals(null) || user.equals("")|| pwd1.equals(null) || pwd1.equals("")
                    ...
                    if (!pwd1.equals(pwd2)){
                        ...
                        if (yanzheng) {
                            ...
                            Toast.makeText(SigninActivity.this,"没有验证或验证码错误",Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                break;
